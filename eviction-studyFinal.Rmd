...
# titlerunning: Eviction Enumeration
# authorrunning:
#   Thomas, Toomet, Kennedy, Ramiller
# thanks: |
#   Funding for this research was provided by the eScience Institute, the Washington Research Foundation, (The Gates foundation?), and Enterprise Community Partners. Unix infrastructure was generously provided by the University of Washington and the Center for Studies in Demography and Ecology. Special thanks to Bill Howe, Bryna Hazelton, Ariel Rokem, Matt Weatherford, ...
...
#    - $^2$The eScience Institute, University of Washington
#    - $^3$The iSchool, University of Washington
#    - $^4$The Center for Studies in Demography and Ecology, University of Washington
...
# abstract: |
#    This research examines racial, ethnic, and gender disparities of evictions and how shifts in regional demographic and political economies exacerbates housing insecurity. Using data science tools we pull and scrape 1.2 million pages of eviction court records for Washington State from 2004 to 2017. This process allows us to estimate race and sex using Bayesian models and apply natural language processing (NLP) to extract addresses, reason for eviction, amounts owed, and other important sociological contexts necessary to understand the causes and consequences of eviction. Finally, we apply spatial analysis techniques and urban sociological theory to model how regional shifts in demographics, housing, homelessness, and income drive evictions in the state. Early results on three counties show that Black adults are evicted almost 6 and 7 times more than Whites with the number of evicted Black adults equaling 11% of the Black population in King County and 21% in Pierce County. This work will inform policies on racial and gender rights to housing as well as provide reproducible tools to advance the emerging field of computational sociology.
...
# bibliography: evictions.bib
# output:
#     bookdown::pdf_document2:
#       toc: no

# header-includes: # latex commands
#   - \usepackage{helvet}
...
#   - \usepackage{xcolor}
#   - \makeatletter
#   - \renewcommand{\maketitle}{\bgroup\setlength{\parindent}{0pt}\begin{flushleft}\LARGE\textbf{\@title}\newline\newline\normalsize\@author\end{flushleft}\egroup}
---
